const CACHE_VERSION = "jojo-static-v2026-06-07-4";
const APP_SHELL = [
    "./",
    "./index.html",
    "./offline.html",
    ...
    "./jogos/jogos.css?v=5",
    "./jogos/jogos.js?v=8",
    "./jogos/jogos.data.js?v=8",
    "./jogos/popit-soma/",
    "./jogos/popit-soma/index.html",
    "./jogos/popit-soma/styles.css?v=4",
    ...
    "./jogos/tabuada-pitagoras/styles.css?v=9",
